...
const listsBuilder = function listsBuilderFunctions(dom, modal) {
    ...
    const createAddTodo = function createAddTodoButton(parent, current) {
        const addTodoButton = dom.createElement({
            ...
            innerHTML:
                '<span class="material-symbols-rounded">add</span><label>New Todo</label>',
            attributes: [
                {
                    name: 'index',
                    value: current.index,
    ...
    const warningModal = modal.actionModal({
        ...
        buttonHTML:
            '<span class="material-symbols-rounded">delete_forever</span><label>Delete Forever</label>',
    })
    ...
    const createDeleteList = function createDeleteListButton(parent, current) {
        const deleteListButton = dom.createElement({
            ...
            innerHTML:
                '<label>Delete List</label><span class="material-symbols-rounded">delete_forever</span>',
            attributes: [
                {
                    name: 'index',
                    value: current.index,
    ...
    const buildAddList = function buildAddListElements() {
        ...
        const addListButton = dom.createElement({
            ...
            innerHTML:
                '<span class="material-symbols-rounded">add</span><label>New List</label>',
        })
